...
import { Award, Quote, CheckCircle2, Target, Trophy, GraduationCap } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-[#2D2A26] mb-4">
            Meet the <span className="text-[#E76F51]">Coach</span>
          </h2>
            ...
            <div className="w-full lg:w-[40%] flex-shrink-0">
              <div className="relative">
                <div className="aspect-[4/5] w-full max-w-[350px] md:max-w-full mx-auto rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden border-4 border-white shadow-2xl relative">
                  <Image 
                    src="/fadil.jpeg" // Update with actual image path
                    alt="Fadil C Basheer - Arena Candidate Master" 
                    fill 
                ...
                <div className="absolute -bottom-6 -right-2 md:-right-6 bg-[#5C1F1C] text-white p-4 md:p-5 rounded-2xl shadow-xl flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xl md:text-2xl font-black leading-none">ACM</p>
            ...
            <div className="flex-1 text-center lg:text-left pt-4 lg:pt-0">
              <div className="mb-6 md:mb-8">
                ...
                <p className="text-[#E76F51] font-black uppercase tracking-[0.2em] text-xs md:text-sm">
                  FIDE Rated Player & Arena Candidate Master
                </p>
              </div>
              ...
              <div className="bg-[#2D2A26] text-white p-6 md:p-10 rounded-[1.5rem] md:rounded-[2rem] relative mb-10 overflow-hidden group">
                ...
                <p className="font-serif italic text-base md:text-xl leading-relaxed relative z-10">
                  &quot;Chess is not just about the moves we make, but the clarity of the plan behind them. My goal is to build players who can navigate complexity with calmness and precision.&quot;
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  { 
                    val: "State Coach", 
                    lab: "Kerala U-17 (24-25)", 
                    icon: <Target className="w-5 h-5 text-[#E76F51]" /> 
                  },
                  { 
                    val: "Certified", 
                    lab: "School Instructor", 
                    icon: <GraduationCap className="w-5 h-5 text-[#2D2A26]" /> 
                  },
                  { 
                    val: "Positional", 
                    lab: "Strategy Expert", 
                    icon: <Award className="w-5 h-5 text-[#bda030]" /> 
                  }
                ].map((stat, i) => (
