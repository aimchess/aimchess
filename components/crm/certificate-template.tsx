...
export function CertificateTemplate({ data, forceDesktop = false }: { data: CertificateData; forceDesktop?: boolean }) {
  ...
  return (
    <div className={`printable-cert-container relative w-full min-w-[320px] bg-[#faf9f5] text-[#071938] rounded-none shadow-2xl border-[#071938] overflow-hidden select-none font-sans flex flex-col justify-between ${
      forceDesktop 
        ? "p-6 border-[10px] aspect-[1.414/1] w-[1100px] h-[778px] min-h-0" 
        : "p-2 sm:p-4 md:p-6 border-[6px] sm:border-[10px] aspect-auto md:aspect-[1.414/1] max-w-[1100px] mx-auto min-h-[520px] md:min-h-0"
    }`}>
      
      {/* Outer Double Gold Border - Sharp Rectangular Corners */}
      <div className={`absolute border-[#d4af37] rounded-none pointer-events-none z-10 ${
        forceDesktop ? "inset-3 border-2" : "inset-1.5 sm:inset-2 md:inset-3 border sm:border-2"
      }`}></div>
      <div className={`absolute border-[#c59b27]/40 rounded-none pointer-events-none z-10 ${
        forceDesktop ? "inset-4" : "inset-2.5 sm:inset-3 md:inset-4"
      }`}></div>

      {/* 4 Corner Ornaments */}
      {/* Top-Left Corner */}
      <div className={`absolute pointer-events-none z-20 ${
        forceDesktop ? "top-3 left-3 w-16 h-16" : "top-2 left-2 sm:top-3 sm:left-3 w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16"
      }`}>
      ...
      {/* Top-Right Corner */}
      <div className={`absolute pointer-events-none z-20 transform rotate-90 ${
        forceDesktop ? "top-3 right-3 w-16 h-16" : "top-2 right-2 sm:top-3 sm:right-3 w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16"
      }`}>
        <svg viewBox="0 0 100 100" className="w-full h-full fill-none stroke-[#c59b27]" strokeWidth="4">
          <path d="M 10 30 L 10 10 L 30 10 M 10 10 L 45 45" />
          <circle cx="10" cy="10" r="4" fill="#c59b27" />
      ...
      {/* Bottom-Left Corner */}
      <div className={`absolute pointer-events-none z-20 transform -rotate-90 ${
        forceDesktop ? "bottom-3 left-3 w-16 h-16" : "bottom-2 left-2 sm:bottom-3 sm:left-3 w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16"
      }`}>
        <svg viewBox="0 0 100 100" className="w-full h-full fill-none stroke-[#c59b27]" strokeWidth="4">
          <path d="M 10 30 L 10 10 L 30 10 M 10 10 L 45 45" />
          <circle cx="10" cy="10" r="4" fill="#c59b27" />
      ...
      {/* Bottom-Right Corner */}
      <div className={`absolute pointer-events-none z-20 transform rotate-180 ${
        forceDesktop ? "bottom-3 right-3 w-16 h-16" : "bottom-2 right-2 sm:bottom-3 sm:right-3 w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16"
      }`}>
        <svg viewBox="0 0 100 100" className="w-full h-full fill-none stroke-[#c59b27]" strokeWidth="4">
          <path d="M 10 30 L 10 10 L 30 10 M 10 10 L 45 45" />
          <circle cx="10" cy="10" r="4" fill="#c59b27" />
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0" style={{ opacity: 0.03 }}>
        <img src="/aim-logo.jpeg" alt="Watermark" className={forceDesktop ? "w-96 h-96 object-contain" : "w-64 h-64 md:w-96 md:h-96 object-contain"} />
      </div>
      ...
      <div className="relative z-20 flex items-start justify-between px-1 sm:px-4 pt-1 sm:pt-3">
        ...
        <div className={forceDesktop ? "flex flex-col items-center justify-center w-44 shrink-0" : "flex flex-col items-center justify-center w-20 sm:w-32 md:w-44 shrink-0"}>
          <img 
            src="/aim-logo.jpeg" 
            alt="AIM Chess Academy Logo" 
            className={forceDesktop ? "w-36 h-36 object-contain filter drop-shadow-sm" : "w-16 h-16 sm:w-24 sm:h-24 md:w-36 md:h-36 object-contain filter drop-shadow-sm"} 
          />
        </div>

        {/* Center: Title & Certificate Banner */}
        <div className="flex-1 text-center px-1 sm:px-2">
          <h1 className={forceDesktop ? "text-3xl font-black text-[#071938] tracking-[0.2em] uppercase font-serif" : "text-sm sm:text-xl md:text-3xl font-black text-[#071938] tracking-[0.1em] sm:tracking-[0.2em] uppercase font-serif"}>
            AIM CHESS ACADEMY
          </h1>
          
          {/* Subtitle flanked with lines */}
          <div className="flex items-center justify-center gap-1 sm:gap-2 my-0.5 sm:my-1">
            <div className={forceDesktop ? "h-[1px] w-20 bg-gradient-to-r from-transparent to-[#c59b27]" : "h-[1px] w-6 sm:w-12 md:w-20 bg-gradient-to-r from-transparent to-[#c59b27]"}></div>
            <span className={forceDesktop ? "text-xs font-bold text-[#0c4a85] tracking-[0.25em] uppercase" : "text-[7px] sm:text-[10px] md:text-xs font-bold text-[#0c4a85] tracking-[0.15em] sm:tracking-[0.25em] uppercase"}>
              ACHIEVE • INSPIRE • MAINTAIN
            </span>
            <div className={forceDesktop ? "h-[1px] w-20 bg-gradient-to-l from-transparent to-[#c59b27]" : "h-[1px] w-6 sm:w-12 md:w-20 bg-gradient-to-l from-transparent to-[#c59b27]"}></div>
          </div>
          ...
          <div className="flex items-center justify-center gap-1 sm:gap-2 mt-1 sm:mt-2">
            ...
            <p className={forceDesktop ? "text-xs font-medium text-[#071938] italic" : "text-[9px] sm:text-[11px] md:text-xs font-medium text-[#071938] italic"}>
        ...
        <div className={forceDesktop ? "w-36 shrink-0 flex flex-col items-center" : "w-20 sm:w-28 md:w-36 shrink-0 flex flex-col items-center"}>
          <div className={forceDesktop ? "bg-[#071938] text-white border-2 border-[#c59b27] rounded-none p-2 text-center w-full shadow-md relative overflow-hidden" : "bg-[#071938] text-white border sm:border-2 border-[#c59b27] rounded-none p-1 sm:p-2 text-center w-full shadow-md relative overflow-hidden"} style={{ backgroundColor: '#071938' }}>
            ...
            {/* Stars */}
            <div className={forceDesktop ? "flex justify-center text-amber-400 text-xs my-0.5" : "flex justify-center text-amber-400 text-[8px] sm:text-[10px] md:text-xs my-0.5"}>
              ★ ★ ★ ★ ★
            </div>
      ...
      <div className="relative z-20 my-auto text-center px-2 sm:px-6 md:px-12 py-1">
        ...
        <div className={`no-print justify-center items-center gap-3 mb-2 ${
        ...
        <div className="max-w-xl mx-auto border-b border-[#c59b27]/60 pb-1">
          <span 
            className={`font-extrabold text-[#071938] block tracking-wide ${
              forceDesktop ? "text-5xl" : "text-2xl sm:text-4xl md:text-5xl"
            }`}
      ...
      <div className="relative z-20 px-1 sm:px-4 pb-1 sm:pb-2">
        ...
        {/* 4 Details Columns */}
        <div className={`grid gap-1.5 sm:gap-2 border-t border-[#c59b27]/30 pt-1.5 sm:pt-2 text-center max-w-3xl mx-auto ${
          forceDesktop ? "grid-cols-4" : "grid-cols-2 sm:grid-cols-4"
        }`}>
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className={forceDesktop ? "text-[9px] font-bold text-[#071938] uppercase tracking-wider" : "text-[7px] sm:text-[8px] md:text-[9px] font-bold text-[#071938] uppercase tracking-wider"}>DATE ACHIEVED</p>
            <p className={forceDesktop ? "text-xs font-extrabold text-[#071938]" : "text-[9px] sm:text-[10px] md:text-xs font-extrabold text-[#071938]"}>{dateAchieved}</p>
          </div>

          {/* Col 2: Certificate No. */}
          <div className={`flex flex-col items-center justify-center ${
            forceDesktop ? "border-l border-gray-200" : "sm:border-l border-gray-200"
          }`}>
            <div className="w-5 h-5 sm:w-7 sm:h-7 rounded-none border border-amber-500/50 flex items-center justify-center text-amber-600 mb-0.5 bg-amber-50/50 text-xs sm:text-base">
              🏅
            </div>
            <p className={forceDesktop ? "text-[9px] font-bold text-[#071938] uppercase tracking-wider" : "text-[7px] sm:text-[8px] md:text-[9px] font-bold text-[#071938] uppercase tracking-wider"}>CERTIFICATE NO.</p>
            <p className={forceDesktop ? "text-xs font-extrabold text-[#071938] font-mono" : "text-[9px] sm:text-[10px] md:text-xs font-extrabold text-[#071938] font-mono"}>{certNo}</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center border-l border-gray-200">
            ...
            <p className={forceDesktop ? "text-[9px] font-bold text-[#071938] uppercase tracking-wider" : "text-[7px] sm:text-[8px] md:text-[9px] font-bold text-[#071938] uppercase tracking-wider"}>VERIFY CERTIFICATE</p>
          ...
          <div className="flex flex-col items-center justify-center border-l border-gray-200 relative">
            <span 
              className={`font-bold text-[#071938] -mb-1 ${
            ...
            <div className={forceDesktop ? "w-24 border-t border-gray-300 my-0.5" : "w-16 sm:w-24 border-t border-gray-300 my-0.5"}></div>
            <p className={forceDesktop ? "text-[9px] font-black text-[#071938] uppercase tracking-wider" : "text-[8px] sm:text-[9px] font-black text-[#071938] uppercase tracking-wider"}>SOUMEN BANERJEE</p>
            <p className={forceDesktop ? "text-[8px] text-gray-500 font-medium" : "text-[7px] sm:text-[8px] text-gray-500 font-medium"}>Founder & Head Coach</p>
            <p className={forceDesktop ? "text-[7px] text-gray-400" : "text-[6px] sm:text-[7px] text-gray-400"}>AIM Chess Academy</p>
          </div>
        ...
        <div className="mt-1.5 sm:mt-2 text-center max-w-2xl mx-auto">
          <div className={forceDesktop ? "bg-[#071938] text-white py-1 px-4 rounded-none shadow-md border-y border-[#c59b27]" : "bg-[#071938] text-white py-0.5 sm:py-1 px-2 sm:px-4 rounded-none shadow-md border-y border-[#c59b27]"}>
            <p className={forceDesktop ? "text-xs font-black tracking-widest uppercase" : "text-[8px] sm:text-[10px] md:text-xs font-black tracking-widest uppercase"}>
          ...
          <div className="flex items-center justify-center gap-1 sm:gap-2 mt-0.5 sm:mt-1">
            ...
            <span className={forceDesktop ? "text-[10px] font-bold text-[#071938] tracking-widest" : "text-[8px] sm:text-[9px] md:text-[10px] font-bold text-[#071938] tracking-widest"}>
        ...
        <div className={`flex flex-wrap items-center justify-between gap-1 text-[#071938] font-bold mt-1.5 sm:mt-2 pt-1 border-t border-gray-200 ${
          forceDesktop ? "text-[9px]" : "text-[7px] sm:text-[8px] md:text-[9px]"
        }`}>
